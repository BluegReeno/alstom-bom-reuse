...
NOTES: Final[tuple[NoteScript, ...]] = (
    ...
    NoteScript("D", "2025-10-02", "en", fact=FactScript("obsolescence", "TRAC-EXHAUST-KIT", effective_date="2026-02-01")),
    ...
    NoteScript("E", "2025-06-17", "fr", fact=FactScript("replacement", "HVAC-FILTER", cited_as="HVAC_FILTER", replaced_by="HVAC-FILTER-F9", effective_date="2026-01-01")),
    NoteScript("E", "2025-09-08", "fr", fact=FactScript("obsolescence", "BRK-PARKING-ACT", effective_date="2027-01-01")),
    ...
    NoteScript("C", "2025-03-24", "en", fact=FactScript("replacement", "PIS-SIGN-STD", replaced_by="PIS-SIGN-STD-V2", effective_date="2025-09-01")),
    NoteScript("C", "2025-04-07", "mixed", fact=FactScript("replacement", "HVAC-CTRL-BOARD", replaced_by="HVAC-CTRL-BOARD-R2", effective_date="2025-06-01")),
    NoteScript("C", "2025-04-28", "fr", fact=FactScript("replacement", "SEAT-TIPUP", replaced_by="SEAT-TIPUP-SOFT", effective_date="2025-12-01")),
    NoteScript("C", "2025-05-12", "en", fact=FactScript("replacement", "TRAC-TRANSFORMER", replaced_by="TRAC-TRANSFORMER-LW", effective_date="2026-03-01")),
    NoteScript("C", "2025-05-26", "en", fact=FactScript("replacement", "LIGHT-EMERG-UNIT", cited_as="light-emerg-unit", replaced_by="LIGHT-EMERG-UNIT-LI", effective_date="2026-04-01")),
    NoteScript("C", "2025-06-09", "en", fact=FactScript("obsolescence", "COUP-ELEC-HEAD", effective_date="2026-06-01")),
    NoteScript("C", "2025-06-23", "fr", fact=FactScript("obsolescence", "SEAT-END-PANEL", effective_date="2026-09-01")),
